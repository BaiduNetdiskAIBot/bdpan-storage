...
> 百度网盘 skill — 上传、下载、转存、分享、搜索、文件管理，一句话搞定。
...
```
把网盘里的 report.pdf 移动到 backup 目录
```

```
在网盘里新建一个 projects 文件夹
```
...
macOS / Linux / Windows (仅 WSL 环境，不支持 Windows 原生)
